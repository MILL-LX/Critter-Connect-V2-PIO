...
#define PWM_ON 200    // PWM value for motor on
...
const int stepsPerRevolution = 10; // Number of steps for one full revolution
...
void TestDevices()
{
  ...
  Serial.println("starting steps");
  return;
  
  stepper1.step(stepsPerRevolution);
  Serial.println("started steps");
  delay(3000);
